...
- Student: Course Offering/join, materials, Viewer/Note/Tutor, Personal RAG, Quiz, Progress, Plan.
...
- Sở hữu auth/RBAC, Subject/Semester, Course Offering/Enrollment, document/publication, Note, Quiz lifecycle/scoring, progress và study plan.
