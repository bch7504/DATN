...
| STU-FR-002 | Student xem lớp theo `PENDING`, `APPROVED`, `REJECTED`, `ARCHIVED`. |
...
|---|---|---|---|
| `POST /api/v1/student/enrollments` | `{joinCode}` | `201/200` enrollment `PENDING` | invalid/closed/duplicate |
